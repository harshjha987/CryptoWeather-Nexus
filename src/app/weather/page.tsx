...
async function page() {
  ...
  const cities = ["New York", "London", "Tokyo", "Kolkata", "Sydney", "Mumbai", "Delhi", "Patna", "Bengaluru"]
  return (
    <div className='space-y-6'>
      <div>
        <h1 className='text-3xl font-bold
        tracking-tight'>Weather</h1>
        <p className='text-muted-foreground'>
          Current weather consitions in major cities 
          around the world.
        </p>
      </div>
      ...
      lg:grid-cols-3'>
        <Suspense fallback = {Array(9)
          .fill(0)
          .map((_,i)=> <Skeleton key={i} className='h-[150px]
          w-full' />)
        }>
